                    ...
                    <form action="{{ route('apply.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div x-show="currentStep === 1" class="space-y-8 animate-fadeIn">
                            <div class="space-y-2">
                                ...
                                <p class="text-sm text-slate-500">Please provide your contact and identification
                                    details.</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="full_name" class="input-class"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nationality" class="input-class" placeholder="Liberian"
                                        required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="city_of_residence" class="input-class"
                                        placeholder="Paynesville, Montserrado" required>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="email" name="email" class="input-class" placeholder="name@example.com"
                                        required>
                                </div>

                                <div class="sm:col-span-2">
                                    <label class="form-label">Home Address <span class="text-red-500">*</span></label>
                                    <input type="text" name="home_address" class="input-class"
                                        placeholder="Community / Neighborhood Address" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div x-show="currentStep === 3" class="space-y-8 animate-fadeIn">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="form-label">Institution Attended <span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="institution" class="input-class" required>
                                </div>

                                <div>
                                    <label class="form-label">Graduation Year <span
                                            class="text-red-500">*</span></label>
                            ...
                            <div class="pt-8 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="file" name="cv"
                                        class="input-class file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-700 hover:file:bg-slate-200"
                                        required>
                                </div>
                                <div>
                        ...
                        <div x-show="currentStep === 5" class="space-y-8 animate-fadeIn">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label class="form-label">Current Department <span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="current_dept" class="input-class"
                                        :required="applicantType === 'current_teacher'">
                                </div>
                                <div>
                                    <label class="form-label">Years Served at CMFI <span
                                            class="text-red-500">*</span></label>
                        ...
                        <div x-show="currentStep === 7" class="space-y-8 animate-fadeIn">
                            <div class="space-y-2">
                                <h2 class="text-2xl font-bold text-slate-900 font-headline">References & Availability
                                </h2>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="reference_data" class="input-class" rows="4"
                                        placeholder="Name, Position, Contact Details..."></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div x-show="currentStep === 8" class="space-y-8 animate-fadeIn">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea name="personal_statement" class="input-class" rows="6"
                                        placeholder="Why do you want to teach at CMFI Bilingual High School?"></textarea>
                                </div>
                                ...
                                <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 flex gap-4 items-start">
                                    ...
                                    <label for="declaration" class="text-sm text-slate-600 leading-relaxed">
                                        ...
                                        knowledge. I understand that any false statement is grounds for immediate
                        ...
                        <div class="flex items-center justify-between mt-12 pt-8 border-t border-slate-50 gap-4">
                            <button type="button" x-show="currentStep > 1" @click="handleBack()"
                                class="btn-secondary min-w-[140px]">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                                    stroke-linejoin="round" class="mr-2 inline">
                            ...
                            <button type="button" x-show="currentStep < totalActiveSteps()" @click="handleNext()"
                                class="btn-primary flex-1 max-w-[320px] text-lg py-5">
                                Next Step
                            ...
                            <button type="submit" x-show="currentStep === totalActiveSteps()"
                                class="btn-primary flex-1 max-w-[320px] text-lg py-5" :disabled="isPending">
