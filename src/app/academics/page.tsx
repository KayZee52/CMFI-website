                     ...
                     <div className="mt-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                        {departments.map((dept, index) => (
                             <AnimateOnScroll key={dept.name} delay={index * 100}>
                                <Card className="p-6 h-full transition-all duration-300 hover:shadow-lg hover:border-primary/50 hover:scale-105 flex flex-col items-center justify-center text-center bg-primary/10">
                                    <div className="p-3 bg-primary/20 text-primary rounded-lg mb-4">
